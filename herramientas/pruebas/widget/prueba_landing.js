...
(async () => {
  ...
  for (const ancho of [1280, 390]) {
    ...
    for (const ruta of ["/", "/privacidad.html", "/accesibilidad.html", "/integrar.html", "/comparar.html", "/demo.html", "/evidencia.html", "/presentacion.html", "/una-pagina.html", "/guia.html", "/guion-prueba.html", "/manual.html", "/cumplimiento.html", "/mapa-del-sitio.html", "/idiomas.html"]) {
      const errores = [];
