...
```html
<script src="https://winclus.com/widget-0.6.4.js" async integrity="sha384-RCTjJXKtaYqPauMYailMtO4ArpEiagm8X98p3MrBoK/sDWYtV4EQ42lPmnqhpNVg" crossorigin="anonymous"></script>
```
