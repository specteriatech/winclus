...
(function () {
  ...
  var DICC = {
    en: {
      ...
      "Ver mejor": "See better", "Tamaño del texto": "Text size", "Alto contraste": "High contrast", "Modo oscuro": "Dark mode", "Resaltar enlaces": "Highlight links", "Guía de lectura": "Reading guide", "Cursor del ratón grande": "Large mouse cursor", "Pausar animaciones": "Pause animations",
      "Colores y calma": "Colors and calm", "Corrección de color para daltonismo": "Color correction for color blindness", "Ninguna": "None", "Protanopia (rojo)": "Protanopia (red)", "Deuteranopia (verde)": "Deuteranopia (green)", "Tritanopia (azul)": "Tritanopia (blue)", "Escala de grises": "Grayscale",
      ...
      "Leer con menos esfuerzo": "Read with less effort", "Lupa de pantalla: agranda la página alrededor del puntero": "Screen magnifier: enlarges the page around the pointer", "Aumento de la lupa de pantalla": "Magnifier zoom", "Lectura limpia: solo el texto, grande": "Clean reading: just the text, large", "Máscara de enfoque: oscurece todo menos una franja": "Focus mask: darkens everything but a strip", "Letras y palabras más separadas": "Wider letter and word spacing", "Atenuar imágenes y vídeos": "Dim images and videos",
      "Lector de pantalla": "Screen reader", "Lector de pantalla activado": "Screen reader on", "Modo fácil": "Easy mode", "Un panel con solo seis botones grandes, para quien se pierde con tantas opciones.": "A panel with just a few big buttons, for anyone lost among so many options.",
      "Para personas ciegas o con muy poca visión: lee la página con voz y se maneja con el teclado (↓ ↑ leen, h encabezados, l enlaces, b botones, f campos, Intro activa, F1 ayuda). Si ya usas NVDA, JAWS o VoiceOver no lo actives: se pisarían.": "For blind or very low-vision people: reads the page aloud and works from the keyboard (↓ ↑ read, h headings, l links, b buttons, f fields, Enter activates, F1 help). If you already use NVDA, JAWS or VoiceOver, leave it off: they would clash.",
      ...
      "Frases para decir": "Phrases to say", "Tablero de pictogramas": "Pictogram board", "Guardar frases": "Save phrases", "Volver a las de ejemplo": "Back to the examples", "Una por línea (hasta 16). Aparecen en la tecla «Frases» del teclado.": "One per line (up to 16). They appear under the “Phrases” key.",
      "Para quien no lee ni escribe bien: un tablero de dibujos (pictogramas ARASAAC) para formar frases y decirlas con voz.": "For people who do not read or write well: a board of pictures (ARASAAC pictograms) to build sentences and say them aloud.",
      "Órdenes por voz": "Voice commands", "Escuchar órdenes": "Listen for commands", "Dejar de escuchar": "Stop listening",
      "Sonidos y subtítulos": "Sounds and captions", "Avisar en pantalla cuando algo suena": "Show an alert when something makes a sound", "Subtítulos grandes en los vídeos (si los traen)": "Large captions on videos (when they have them)", "Subtítulos en vivo (micrófono)": "Live captions (microphone)", "Parar los subtítulos en vivo": "Stop live captions", "Subtítulos en vivo": "Live captions", "Centro de Relevo (intérprete de LSC)": "Centro de Relevo (sign language interpreter)", "Diccionario de Lengua de Señas (INSOR)": "Sign language dictionary (INSOR)",
      "Para quien no oye o oye poco: avisos en pantalla cuando algo suena, subtítulos grandes y con fondo en los vídeos que los traigan, y subtítulos en vivo de lo que se habla cerca (una videollamada, una consulta) usando el micrófono.": "For deaf or hard-of-hearing people: on-screen alerts when something sounds, large captions with a background on videos that have them, and live captions of nearby speech (a video call, an appointment) using the microphone.",
      "Usar con la cara": "Use with your face", "Activar cámara": "Turn on camera", "Apagar cámara": "Turn off camera", "Ver la cámara": "Show the camera", "Modo ahorro: menos batería y calor (analiza 15 imágenes por segundo)": "Power saving: less battery and heat (15 frames per second)",
      "Mueve el puntero con la cabeza o con los ojos y haz clic con un gesto. La cámara se procesa aquí mismo: nada sale de tu equipo.": "Move the pointer with your head or eyes and click with a gesture. The camera is processed right here: nothing leaves your device.",
      ...
      "Cómo se mueve el puntero": "How the pointer moves", "Con la cabeza": "With my head", "Con los ojos": "With my eyes", "Directo": "Direct", "Híbrido": "Hybrid", "Palanca": "Joystick",
      "Calibrar los ojos (unos 40 s)": "Calibrate eyes (about 40 s)", "Recentrar (mirar al centro 2 s)": "Recenter (look at the center 2 s)", "Olvidar la calibración": "Forget calibration", "Suavizado de la mirada": "Gaze smoothing", "Zona quieta alrededor": "Still zone around", "Afinar con la cabeza": "Fine-tune with the head", "Salto mínimo": "Minimum jump", "Centrar (mira al centro)": "Center (look at the center)", "Velocidad": "Speed", "Zona muerta": "Dead zone", "Ganancia vertical": "Vertical gain",
      "Híbrido: la mirada salta a la zona y la cabeza afina.": "Hybrid: gaze jumps to the area, the head fine-tunes.", "Palanca: mirar a un lado empuja el puntero hacia allí; volver al centro lo para.": "Joystick: looking to one side pushes the pointer that way; looking back to the center stops it.",
      "Lupa: el primer gesto agranda, el segundo pulsa": "Magnifier: first gesture zooms, second clicks", "Aumento de la lupa": "Magnifier zoom", "Velocidad con la cabeza": "Head speed", "Suavizado de la cabeza": "Head smoothing", "Aceleración": "Acceleration",
      "Imán a los botones": "Snap to buttons", "Imán activado": "Snap on", "Alcance": "Reach", "También con la cabeza": "Also with the head", "Si el puntero se queda quieto cerca de un botón o enlace, se pega a él.": "If the pointer rests near a button or link, it snaps to it.",
      "Calibración invisible": "Invisible calibration", "Aprender de mis clics": "Learn from my clicks", "Ajustar ahora": "Adjust now", "Olvidar los clics": "Forget clicks", "Aprende de cada clic que haces con la cabeza y calibra los ojos sola.": "Learns from every click you make with your head and calibrates the eyes by itself.",
      "Cómo se hace clic": "How to click", "Parpadeo": "Blink", "Abrir la boca": "Open mouth", "Subir las cejas": "Raise eyebrows", "Quedarse quieto": "Hold still", "Cerrar los ojos al menos": "Close eyes for at least", "Tiempo quieto": "Still time", "Margen de movimiento": "Movement margin", "Mostrar el anillo que se llena": "Show the filling ring",
      "Con los ojos cerrados 1,2 s se abre el menú de clics (clic derecho, doble, arrastrar, rueda, teclado, leer, recentrar o pausar).": "Closing your eyes for 1.2 s opens the click menu (right click, double, drag, scroll, keyboard, read, recenter or pause).",
      "Otras acciones con gestos": "Other gesture actions", "Sensibilidad de los gestos": "Gesture sensitivity", "Mantener el gesto para arrastrar": "Hold the gesture to drag", "Nada": "Nothing", "Clic": "Click", "Clic derecho": "Right click", "Doble clic": "Double click", "Bajar": "Scroll down", "Subir": "Scroll up", "Menú de clics": "Click menu", "Pausar / seguir": "Pause / resume", "Teclado": "Keyboard", "Recentrar": "Recenter", "Leer en voz alta": "Read aloud",
      ...
      "Para quien solo puede accionar una cosa: un pulsador, una tecla o un gesto. Winclus va marcando uno a uno los botones, enlaces y campos de la página (y las filas y teclas del teclado en pantalla); cuando el marcado está en lo que quieres, das la señal. El clic con la cara también vale como señal. Escape lo pausa y lo reanuda.": "For anyone who can only operate one thing: a switch, a key or a gesture. Winclus highlights the page's buttons, links and fields one by one (and the rows and keys of the on-screen keyboard); when the highlight is on what you want, give the signal. The face click also works as the signal. Escape pauses and resumes.",
      ...
      "Pulsa en un campo de la página y escribe con el puntero. Tiene sugerencias de palabras, «Decir», «Frases» y «Dictar».": "Click a field on the page and type with the pointer. It has word suggestions, “Say”, “Phrases” and “Dictate”.",
      ...
      "Dictado": "Dictation", "Dictar": "Dictate", "Parar el dictado": "Stop dictation", "Confirmar antes de escribir lo dictado (di «sí» o «no»)": "Confirm before typing what was dictated (say “yes” or “no”)", "Confirmar lo dictado": "Confirm dictation", "Escribir (o di «sí»)": "Type it (or say “yes”)", "Descartar (o di «no»)": "Discard (or say “no”)",
      "Perfil": "Profile", "Exportar perfil (.winclus)": "Export profile (.winclus)", "Copiar enlace con mi perfil": "Copy a link with my profile", "Importar perfil": "Import profile", "Restablecer todo": "Reset everything", "Acerca de": "About", "Llévate tus ajustes, calibración, frases y palabras a otro navegador o página.": "Take your settings, calibration, phrases and words to another browser or page.",
  ...
  function seccion(titulo) { return el("div", { "class": "wcl-sec" }, titulo ? "<h2>" + T(titulo) + "</h2>" : ""); }
  ...
  tabs.clics.appendChild(s);
  s = seccion("Barrido con un solo pulsador");
  s.appendChild(el("div", { "class": "wcl-estado" }, "Para quien solo puede accionar una cosa: un pulsador, una tecla o un gesto. Winclus va marcando uno a uno los botones, enlaces y campos de la página (y las filas y teclas del teclado en pantalla); cuando el marcado está en lo que quieres, das la señal. El clic con la cara también vale como señal. Escape lo pausa y lo reanuda."));
  s.appendChild(filaSw("barrido", "Barrido activado", aplicarBarrido));
  s.appendChild(filaOpc("barrido_senal", "Señal", [["espacio", "Espacio"], ["intro", "Intro"], ["cualquiera", "Cualquier tecla"], ["raton", "Clic del ratón"]]));
  s.appendChild(filaPaso("barrido_ms", "Tiempo en cada elemento", 400, 4000, 100, function (n) { return (n / 1000).toFixed(1) + " s"; }, function () { if (ajustes.barrido) barridoReprogramar(); }));
  s.appendChild(filaSw("barrido_voz", "Decir en voz alta lo marcado"));
  tabs.clics.appendChild(s);
  ...
  // ============================================= barrido con un solo pulsador ==
  // Recorre en orden lo que se puede accionar y espera una sola señal (Espacio, Intro, cualquier tecla, clic del
  // ratón o el gesto de clic con la cara). Con el teclado en pantalla abierto barre por filas y luego por teclas.
  ...
  function barridoMarcar(e, fila) {
    ...
    if (e) {
      ...
      if (ajustes.barrido_voz) decirVoz(e === boton ? "Winclus" : nombreDe(e), true, false, enWidget(e) ? null : IDIOMA_PAGINA);
  ...
  function barridoPaso() {
    if (!ajustes.barrido || barridoPausa) return;
    if (tecVisible) {
  ...
  function barridoSenal() {
    ...
    if (tecVisible) {
      if (barridoNivel === "teclas" && barridoEl) {
        ...
        barridoEl.classList.remove("wcl-barrido"); barridoEl = null;
      ...
      var e = barridoEl; barridoMarcar(null, null); barridoActivar(e);
    }
    barridoReprogramar();   // tras la señal, un intervalo entero antes de seguir
    return true;
  }
  function aplicarBarrido() {
    clearInterval(barridoTimer); barridoMarcar(null, null); barridoNivel = "pagina"; barridoLista = []; barridoI = -1; barridoPausa = false;
    if (ajustes.barrido) { barridoReprogramar(); avisar("Barrido activado"); decirVoz("Barrido activado. Da la señal cuando el marco azul esté en lo que quieres. Escape lo pausa.", true, true); }
  }
  function esSenalTecla(e) {
    var s = ajustes.barrido_senal;
    if (e.key === "Escape") return "pausa";
  ...
  document.addEventListener("keydown", function (e) {
    ...
    var r = esSenalTecla(e);
    if (r === "pausa") { barridoPausa = !barridoPausa; avisar(barridoPausa ? "Barrido en pausa" : "Barrido en marcha"); if (!barridoPausa) barridoReprogramar(); e.preventDefault(); e.stopPropagation(); return; }
    if (r) { e.preventDefault(); e.stopPropagation(); barridoSenal(); }
  }, true);
