...
(function () {
  ...
  function lecturaLimpia() {
    ...
    limpiaEl = el("div", { "class": "wcl-limpia", "role": "dialog", "aria-label": "Lectura limpia" },
      '<div class="wcl-limpia-barra"><b>Lectura limpia</b><button type="button" data-a="facil">Explicar en fácil</button><button type="button" data-a="leer">Leer en voz alta</button><button type="button" data-a="callar">Callar</button><button type="button" data-a="silabas" aria-pressed="false">Sílabas</button><button type="button" data-a="menos" aria-label="Texto más pequeño">A−</button><button type="button" data-a="mas" aria-label="Texto más grande">A+</button><button type="button" data-a="cerrar" aria-label="Cerrar la lectura limpia">✕ Cerrar</button></div>'
