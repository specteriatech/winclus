...
(function () {
  ...
  var opciones = {
    ...
    describir: (script && script.dataset.describir) || "",  // URL opcional que describe imágenes sin alt (POST {imagen, contexto, idioma} → {texto})
  ...
  var DICC = {
    en: {
      ...
      "💾 Guardar lo escrito en un archivo": "💾 Save the text to a file", "Transcripción de Winclus": "Winclus transcript",
      "Ajustar el puntero a lo que puedo mover": "Fit the pointer to how much I can move",
      "Mueves la cabeza todo lo que puedas durante 8 segundos y Winclus pone la velocidad para que ese movimiento cruce la pantalla. Úsalo cuando te canses o si con el tiempo te cuesta más moverte.": "Move your head as much as you can for 8 seconds and Winclus sets the speed so that movement crosses the screen. Use it when you get tired or if moving becomes harder over time.",
      "Mueve la cabeza todo lo que puedas, sin forzar: a un lado, al otro, arriba y abajo. Tienes ocho segundos.": "Move your head as much as you can, without straining: to one side, to the other, up and down. You have eight seconds.",
      "Mueve la cabeza todo lo que puedas (8 s)": "Move your head as much as you can (8 s)", "Primero activa la cámara": "Turn on the camera first",
      "Para ajustar el puntero, primero activa la cámara.": "To fit the pointer, turn on the camera first.",
      "No he visto moverse la cabeza. Prueba otra vez con la cara bien iluminada y de frente.": "I didn't see your head move. Try again with your face well lit and facing the camera.",
      "Con la cabeza te queda poco movimiento: ni al máximo cruza la pantalla. Te conviene otra forma.": "You have little head movement left: even at maximum it does not cross the screen. Another way will suit you better.",
      "Con la cabeza te queda poco movimiento. ¿Probamos otra forma?": "You have little head movement left. Shall we try another way?",
      "Con los ojos": "With your eyes", "Calibración de 40 segundos": "40-second calibration", "Con un pulsador": "With a switch",
      "Winclus va marcando y tú haces un gesto": "Winclus highlights things and you make a gesture", "Seguir con la cabeza, al máximo": "Keep using my head, at maximum",
      "Listo: con el movimiento que tienes hoy, el puntero cruza la pantalla.": "Done: with the movement you have today, the pointer crosses the screen.", "Velocidad": "Speed",
      "Puntero ajustado a tu movimiento": "Pointer fitted to your movement", "Vamos a ajustar el puntero a lo que puedes mover hoy.": "Let's fit the pointer to how much you can move today.",
      "Abrir los documentos PDF aquí": "Open PDF documents here",
      "🌐 Otro idioma": "🌐 Another language", "Idioma de la página": "Page language", "Para quien lee mejor en otra lengua.": "For people who read better in another language.",
      "Este sitio tiene la página en otros idiomas. Pulsa el tuyo y tus ajustes te siguen:": "This site has the page in other languages. Press yours and your settings come with you:",
      "Este sitio no tiene la página en otros idiomas. Tu navegador puede traducirla: en Chrome y Edge, clic derecho en la página y «Traducir»; en Safari, el botón «aA» de la barra de direcciones; en Firefox, el icono de traducir de la barra de direcciones. Winclus no la traduce para no enviar la página a nadie.": "This site does not have the page in other languages. Your browser can translate it: in Chrome and Edge, right-click the page and choose 'Translate'; in Safari, the 'aA' button in the address bar; in Firefox, the translate icon in the address bar. Winclus does not translate it, so the page is not sent to anyone.",
      "Al pulsar un enlace a un PDF de este sitio, Winclus lo abre en la lectura limpia: letra grande, en voz alta, en fácil y por sílabas. Los PDF de otros sitios se abren como siempre.": "When you press a link to a PDF on this site, Winclus opens it in clean reading: large text, read aloud, in easy words and by syllables. PDFs from other sites open as usual.",
      "Documentos PDF en la lectura limpia": "PDF documents in clean reading", "Documento": "Document", "Documento abierto:": "Document opened:", "páginas": "pages",
      "Abriendo el documento…": "Opening the document…",
      "Este PDF es una imagen escaneada: no tiene texto que leer": "This PDF is a scanned image: it has no text to read",
      "Este documento es una imagen escaneada: no tiene texto que Winclus pueda leer. Pide a la entidad una versión accesible.": "This document is a scanned image: it has no text Winclus can read. Ask the organisation for an accessible version.",
      "No se pudo abrir aquí: pulsa otra vez el enlace para abrirlo como siempre": "It could not be opened here: press the link again to open it as usual",
      "Hecho: cuando pulses un documento PDF de este sitio, lo abro en la lectura limpia para leerlo grande y en voz alta.": "Done: when you press a PDF document on this site, I will open it in clean reading so you can read it large and aloud.",
      "Imagen decorativa": "Decorative image", "Imagen sin descripción del sitio": "Image not described by the site",
      "Pista:": "Clue:", "Pidiendo una descripción…": "Asking for a description…",
      "Todavía no hay nada escrito": "Nothing has been written yet", "Transcripción guardada": "Transcript saved",
...
"Bajar y subir llevando el puntero al borde": "Scroll by moving the pointer to the edge", "Lleva el puntero a la parte de abajo de la pantalla, donde pone «Bajar», y la página baja sola; arriba, donde pone «Subir», sube. Apártalo y para. También bajas abriendo la boca y subes con las cejas, o diciendo «baja» y «sube».": "Move the pointer to the bottom of the screen, where it says “Down”, and the page scrolls down by itself; to the top, where it says “Up”, it scrolls up. Move it away and it stops. You can also scroll down by opening your mouth and up with your eyebrows, or by saying “down” and “up”.",
  ...
  var boton = el("button", { "class": "wcl-btn", "aria-label": "Abrir accesibilidad Winclus", "aria-expanded": "false", "aria-keyshortcuts": "Alt+Shift+W", "type": "button" }, LOGO);
  ...
  // --- «Ajustar el puntero a lo que puedo mover» (ELA que avanza, cansancio) -----------------------------------
  // Con la cabeza, el puntero recorre (cuánto gira la persona) × velocidad. Si la enfermedad avanza o llega el cansancio,
  // el mismo giro deja de cruzar la pantalla. Aquí se mide durante 8 s el movimiento que la persona tiene HOY y se pone
  // la velocidad para que ese movimiento cruce la pantalla. Si ni al máximo alcanza, se proponen los ojos o un pulsador:
  // es el cambio de etapa, y se ofrece en vez de dejar a la persona peleando con un puntero que no llega.
  var alcance = null;
  function ajustarAlcance() {
    if (!camaraActiva) { avisar("Primero activa la cámara", true); decir("Para ajustar el puntero, primero activa la cámara."); return false; }
    if (alcance) return false;
    alcance = { minX: Infinity, maxX: -Infinity, minY: Infinity, maxY: -Infinity, t0: performance.now() };
    var m = "Mueve la cabeza todo lo que puedas, sin forzar: a un lado, al otro, arriba y abajo. Tienes ocho segundos.";
    decir(m); decirVoz(m, true, true); avisar("Mueve la cabeza todo lo que puedas (8 s)", false, 8000);
    var t = setInterval(function () {
      if (det.track) { alcance.minX = Math.min(alcance.minX, det.track[0]); alcance.maxX = Math.max(alcance.maxX, det.track[0]); alcance.minY = Math.min(alcance.minY, det.track[1]); alcance.maxY = Math.max(alcance.maxY, det.track[1]); }
      if (performance.now() - alcance.t0 > 8000 || !camaraActiva) { clearInterval(t); terminarAlcance(); }
    }, 33);
    return true;
  }
  function terminarAlcance() {
    var a = alcance; alcance = null;
    var rx = a.maxX - a.minX, ry = a.maxY - a.minY;
    if (!(rx > 0.5) || !(ry > 0.5)) { var n = "No he visto moverse la cabeza. Prueba otra vez con la cara bien iluminada y de frente."; decir(n); decirVoz(n, true, true); return; }
    // Que el movimiento de hoy recorra el 90 % de la pantalla, a lo ancho y a lo alto
    var necesaria = Math.max(window.innerWidth * 0.9 / rx, window.innerHeight * 0.9 / ry), v = Math.max(5, Math.round(necesaria / 5) * 5);
    ajustes.velocidad = Math.min(60, v); guardar(); refrescos.forEach(function (f) { f(); });
    if (v > 60) {
      var q = "Con la cabeza te queda poco movimiento: ni al máximo cruza la pantalla. Te conviene otra forma.";
      decir(q); decirVoz(q, true, true);
      abrir(true);
      abrirElegir(T("Con la cabeza te queda poco movimiento. ¿Probamos otra forma?"), [
        { texto: T("Con los ojos"), nota: T("Calibración de 40 segundos"), al: function () { ajustes.modo_puntero = "ojos"; guardar(); refrescos.forEach(function (f) { f(); }); if (!calibracion) empezarCalibracion(false); } },
        { texto: T("Con un pulsador"), nota: T("Winclus va marcando y tú haces un gesto"), al: function () { ponerSituacion("pulsador"); pintarSitu(); } },
        { texto: T("Seguir con la cabeza, al máximo"), al: function () {} }
      ]);
      return;
    }
    var ok = T("Listo: con el movimiento que tienes hoy, el puntero cruza la pantalla.") + " " + T("Velocidad") + " " + ajustes.velocidad + ".";
    decir(ok); decirVoz(ok, true, true); avisar("Puntero ajustado a tu movimiento");
  }
  ...
  var subtitulando = false, recSub = null, subFinal = "", subTodo = [];   // subTodo: todo lo dicho, con la hora, para guardarlo
  function empezarSubvivo() {
    ...
    try {
      recSub = crearReconocedor({ interim: true, onresult: function (e) {
        var parcial = "";
        for (var i = e.resultIndex; i < e.results.length; i++) { if (e.results[i].isFinal) { subFinal += e.results[i][0].transcript + " "; anotarSub(e.results[i][0].transcript); } else parcial += e.results[i][0].transcript; }
  ...
  function anotarSub(t) { t = String(t || "").trim(); if (!t) return; var d = new Date(); subTodo.push("[" + ("0" + d.getHours()).slice(-2) + ":" + ("0" + d.getMinutes()).slice(-2) + ":" + ("0" + d.getSeconds()).slice(-2) + "] " + t); refrescos.forEach(function (f) { f(); }); }
  // Guardar lo que se ha escrito en un archivo de texto: para releer una consulta o una clase después
  function guardarTranscripcion() {
    if (!subTodo.length) { avisar("Todavía no hay nada escrito", true); return; }
    var texto = T("Transcripción de Winclus") + " · " + (document.title || location.hostname) + " · " + new Date().toLocaleString() + "\n\n" + subTodo.join("\n") + "\n";
    var a = document.createElement("a"); a.href = URL.createObjectURL(new Blob([texto], { type: "text/plain;charset=utf-8" }));
    a.download = "transcripcion-" + new Date().toISOString().slice(0, 16).replace(/[:T]/g, "-") + ".txt"; a.click();
    avisar("Transcripción guardada");
  }
  ...
  // «Otro idioma», a la vista desde que se abre el panel: la barra de accesibilidad de la sede electrónica debe dejar
  // cambiar el idioma (Res. MinTIC 2893 de 2020, Anexo 1, 4.3.2 b)
  var btnIdioma = botonGrande("🌐 Otro idioma", "suave", function () { mostrarIdiomas(cajaIdiomaInicio.style.display === "none"); });
  btnIdioma.id = "wcl-otro-idioma"; btnIdioma.setAttribute("aria-expanded", "false"); btnIdioma.setAttribute("aria-controls", "wcl-idiomas-inicio");
  var cajaIdiomaInicio = el("div", { "id": "wcl-idiomas-inicio", "class": "wcl-idiomas" }); cajaIdiomaInicio.style.display = "none";
  s.appendChild(btnIdioma); s.appendChild(cajaIdiomaInicio);
  function mostrarIdiomas(si) {
    if (si) pintarIdiomas(cajaIdiomaInicio);
    cajaIdiomaInicio.style.display = si ? "" : "none"; btnIdioma.setAttribute("aria-expanded", si ? "true" : "false");
  }
  ...
  s.appendChild(fCol);
  tabs.ver.appendChild(s);
  s = seccion("Idioma de la página", "Para quien lee mejor en otra lengua.");
  var cajaIdiomaVer = el("div", { "class": "wcl-idiomas" });
  refrescos.push(function () { pintarIdiomas(cajaIdiomaVer); });
  s.appendChild(cajaIdiomaVer);
  tabs.ver.appendChild(s);

  // Cambiar el idioma (Res. MinTIC 2893 de 2020, Anexo 1, 4.3.2 b). Winclus no traduce la página: lleva a las
  // versiones que el propio sitio tiene en otros idiomas (<link rel="alternate" hreflang>, enlaces con hreflang,
  // un selector de idioma con lang, o data-idiomas en el script). Si no hay, explica cómo pedírselo al navegador:
  // así la página no se envía a ningún servicio de traducción.
  function nombreIdioma(c, en) {
    try { var n = new Intl.DisplayNames([en || c], { type: "language" }).of(c); if (n && n.toLowerCase() !== c.toLowerCase()) return n.charAt(0).toUpperCase() + n.slice(1); } catch (e) {}
    return c;
  }
  function idiomasDelSitio() {
    var vistos = {}, lista = [], propio = IDIOMA_PAGINA.split("-")[0];
    function poner(codigo, url) {
      codigo = String(codigo || "").trim(); if (!codigo || /^x-default$/i.test(codigo) || !url) return;
      var base = codigo.split("-")[0].toLowerCase(); if (base === propio || vistos[base]) return;
      var u; try { u = new URL(url, location.href); } catch (e) { return; }
      if (!/^https?:$/.test(u.protocol) || u.href === location.href) return;
      vistos[base] = 1; lista.push({ codigo: codigo, nombre: nombreIdioma(codigo), url: u.href });
    }
    (opciones.idiomas || "").split(",").forEach(function (p) { var i = p.indexOf("="); if (i > 0) poner(p.slice(0, i), p.slice(i + 1).trim()); });
    [].forEach.call(document.querySelectorAll('link[rel~="alternate"][hreflang][href]'), function (l) { poner(l.getAttribute("hreflang"), l.getAttribute("href")); });
    [].forEach.call(document.querySelectorAll("a[hreflang][href]"), function (a) { poner(a.getAttribute("hreflang"), a.getAttribute("href")); });
    // Un selector de idioma sin hreflang: <a lang="en" href="/en/">English</a>. Solo cuenta si el texto es el nombre
    // de ese idioma o su código: un enlace a un artículo en inglés no es «la página en inglés».
    [].forEach.call(document.querySelectorAll("a[lang][href]"), function (a) {
      var c = a.getAttribute("lang"), t = (a.textContent || "").trim().toLowerCase();
      if (t && (t === c.toLowerCase() || t === c.split("-")[0].toLowerCase() || t === nombreIdioma(c, c).toLowerCase() || t === nombreIdioma(c).toLowerCase())) poner(c, a.getAttribute("href"));
    });
    return lista;
  }
  function pintarIdiomas(caja) {
    ...
    if (l.length) {
      ...
      l.forEach(function (x) {
        var b = el("button", { "type": "button", "class": "wcl-big suave", "lang": x.codigo }); b.textContent = "🌐 " + x.nombre;
  ...
  s.appendChild(filaSw("pdf_lectura", "Abrir los documentos PDF aquí", null, "Al pulsar un enlace a un PDF de este sitio, Winclus lo abre en la lectura limpia: letra grande, en voz alta, en fácil y por sílabas. Los PDF de otros sitios se abren como siempre."));
  ...
  var btnGuardarSub = botonGrande("💾 Guardar lo escrito en un archivo", "suave", guardarTranscripcion);
  btnGuardarSub.id = "wcl-guardar-sub";
  refrescos.push(function () { btnGuardarSub.style.display = subTodo.length ? "" : "none"; });
  ...
  if (opciones.camara) {
    ...
    var btnAlcance = botonGrande("Ajustar el puntero a lo que puedo mover", "suave", ajustarAlcance); btnAlcance.id = "wcl-ajustar-alcance";
    gCab.appendChild(btnAlcance);
    gCab.appendChild(el("div", { "class": "wcl-ayuda" }, "Mueves la cabeza todo lo que puedas durante 8 segundos y Winclus pone la velocidad para que ese movimiento cruce la pantalla. Úsalo cuando te canses o si con el tiempo te cuesta más moverte."));
  ...
  tabs.mas.appendChild(s);
  s = seccion("Lo que Winclus arregló en esta página", "Para quien usa lector de pantalla, teclado o zoom: lo que le faltaba a la página y Winclus puso al vuelo. Quien mantiene el sitio debe ponerlo en el código; la lista se lo dice.");
  var arrEl = el("div", { "class": "wcl-estado" }, "");
  var arrLista = el("details", { "class": "wcl-fino" }, "<summary>" + T("Ver la lista") + "</summary>");
  var arrUl = el("ul", { "style": "margin:6px 0 0 18px;padding:0;font-size:.92em" }); arrLista.appendChild(arrUl);
  refrescos.push(function () {
    var perso = pendientes.length ? " · " + pendientes.length + " " + T("cosa(s) que necesitan a una persona") : "";
    arrEl.textContent = !opciones.arreglos ? T("Este sitio pidió no arreglar nada al vuelo.") : !arreglosHechos ? T("Todavía revisando la página…") : (arreglos.length ? arreglos.length + " " + T("arreglo(s) hechos") : T("No hizo falta arreglar nada")) + perso;
    arrUl.innerHTML = ""; arreglos.concat(pendientes).forEach(function (a) { var li = document.createElement("li"); li.textContent = (a.selector ? a.selector + ": " : "") + a.que; arrUl.appendChild(li); });
    arrLista.style.display = arreglos.length + pendientes.length ? "" : "none";
  });
  s.appendChild(arrEl); s.appendChild(arrLista);
  s.appendChild(botonGrande("Copiar la lista para quien mantiene el sitio", "suave", function () {
    var t = informeArreglos(), listo = function () { avisar("Lista copiada"); };
    if (navigator.clipboard && navigator.clipboard.writeText) navigator.clipboard.writeText(t).then(listo, function () { window.prompt("Copia esta lista:", t); }); else window.prompt("Copia esta lista:", t);
  }));
  tabs.mas.appendChild(s);
  s = seccion("Acerca de");
  ...
  // fuente (opcional): { titulo, bloques: [{tag, texto}] } para mostrar otro texto (un PDF del sitio) en vez de la página
  function lecturaLimpia(fuente) {
    if (fuente && !fuente.bloques) fuente = null;   // llamada desde un botón: lo que llega es el evento del clic
    if (limpiaEl) { cerrarLimpia(); if (!fuente) return; }
    contar("limpia");
    var m = document.querySelector("main,article,[role=main]") || document.body, partes = [], bloques = [];
    if (fuente) fuente.bloques.forEach(function (b) { var tg = b.tag === "h1" || b.tag === "h2" ? b.tag : "p"; bloques.push({ tag: tg, texto: b.texto }); partes.push("<" + tg + ">" + esc(b.texto) + "</" + tg + ">"); });
    else m.querySelectorAll("h1,h2,h3,h4,p,li,blockquote,img,figcaption").forEach(function (e) {
  ...
  // --- los PDF del sitio, dentro de la lectura limpia --------------------------------------------------
  // Muchos trámites están en un PDF. Con «Abrir los documentos PDF aquí», al pulsar un enlace a un PDF del MISMO sitio
  // Winclus saca su texto con pdf.js (servido desde winclus.com, se carga solo al usarlo) y lo pone en la lectura
  // limpia: letra grande, lectura en voz alta, en fácil, sílabas. Los PDF de otro sitio no se pueden leer desde aquí
  // (el navegador no deja: CORS) y se abren como siempre. Un PDF escaneado no tiene texto y se dice.
  var pdfjsProm = null, pdfFallidos = {};
  function cargarPdfjs() {
    if (!pdfjsProm) pdfjsProm = import(ORIGEN + "/pdfjs/pdf.min.mjs").then(function (m) {
      m.GlobalWorkerOptions.workerSrc = ORIGEN + "/pdfjs/pdf.worker.min.mjs"; return m;
    }, function (e) { pdfjsProm = null; throw e; });
    return pdfjsProm;
  }
  function textoPdf(doc) {
    var bloques = [], i = 0, total = Math.min(doc.numPages, 200);
    function pagina() {
      if (++i > total) return Promise.resolve(bloques);
      return doc.getPage(i).then(function (p) { return p.getTextContent(); }).then(function (tc) {
        // Las líneas se juntan en párrafos; una línea vacía (o el final de la página) cierra el párrafo
        var actual = "";
        tc.items.forEach(function (it) {
          var s = it.str || "";
          if (!s.trim() && it.hasEOL) { if (actual.trim()) { bloques.push({ tag: "p", texto: actual.replace(/\s+/g, " ").trim() }); actual = ""; } return; }
          actual += s + (it.hasEOL ? " " : "");
        });
        if (actual.trim()) bloques.push({ tag: "p", texto: actual.replace(/\s+/g, " ").trim() });
        return pagina();
      });
    }
    return pagina();
  }
  function abrirPdfEnLectura(url, nombre) {
    avisar("Abriendo el documento…"); decir(T("Abriendo el documento…"));
    var buf, titulo = nombre || T("Documento"), paginas = 0;
    return fetch(url, { credentials: "same-origin" })
      .then(function (r) { if (!r.ok) throw new Error("http " + r.status); return r.arrayBuffer(); })
      .then(function (b) { buf = b; return cargarPdfjs(); })
      .then(function (pdfjs) { return pdfjs.getDocument({ data: new Uint8Array(buf), isEvalSupported: false }).promise; })
      .then(function (doc) {
        paginas = doc.numPages;
        return doc.getMetadata().then(function (m) { if (m && m.info && m.info.Title && m.info.Title.trim()) titulo = m.info.Title.trim(); }, function () {})
          .then(function () { return textoPdf(doc); });
      })
      .then(function (bloques) {
        if (!bloques.length) {
          avisar("Este PDF es una imagen escaneada: no tiene texto que leer", true);
          decirVoz(T("Este documento es una imagen escaneada: no tiene texto que Winclus pueda leer. Pide a la entidad una versión accesible."), true, true);
          return;
        }
        bloques.unshift({ tag: "h1", texto: titulo });
        lecturaLimpia({ titulo: titulo, bloques: bloques });
        decir(T("Documento abierto:") + " " + titulo + " · " + paginas + " " + T("páginas"));
        contar("pdf");
      })
      .catch(function () {
        pdfFallidos[url] = true;
        avisar("No se pudo abrir aquí: pulsa otra vez el enlace para abrirlo como siempre", true);
      });
  }
  function enlacePdf(a) {
    var h = a && a.getAttribute && a.getAttribute("href"); if (!h) return null;
    try { var u = new URL(h, location.href); return /\.pdf$/i.test(u.pathname) ? u : null; } catch (e) { return null; }
  }
  document.addEventListener("click", function (e) {
    if (!ajustes.pdf_lectura || e.defaultPrevented || e.button !== 0 || e.ctrlKey || e.metaKey || e.shiftKey || e.altKey) return;
    var a = e.target && e.target.closest ? e.target.closest("a[href]") : null;
    var u = a && !enWidget(a) ? enlacePdf(a) : null;
    if (!u || u.origin !== location.origin || pdfFallidos[u.href]) return;   // de otro sitio, o ya falló: como siempre
    e.preventDefault();
    abrirPdfEnLectura(u.href, (a.innerText || a.textContent || u.pathname.split("/").pop()).replace(/\s+/g, " ").trim());
  });
  ...
  // --- imágenes sin texto alternativo (el sitio no las describió) --------------------------------
  // Nunca se inventa una descripción. Sin servicio, se da la mejor pista que hay en la página (etiqueta, título, pie de
  // foto, el texto del enlace que la contiene o el nombre del archivo) y se dice que el sitio no la describió. Con
  // data-describir="URL", se pide la descripción a ESE servicio (del sitio: la imagen no pasa por Winclus) y se guarda.
  var descripciones = {};   // src → texto del servicio; 0 = pedida y esperando
  function pistaImagen(e) {
    var t = (e.getAttribute("aria-label") || e.getAttribute("title") || "").trim(); if (t) return t;
    var fig = e.closest ? e.closest("figure") : null, cap = fig && fig.querySelector("figcaption");
    if (cap && cap.textContent.trim()) return cap.textContent.replace(/\s+/g, " ").trim();
    var a = e.closest ? e.closest("a,button") : null;
    if (a) { var ta = (a.innerText || a.textContent || "").replace(/\s+/g, " ").trim(); if (ta) return ta; }
    var archivo = (e.currentSrc || e.src || "").split(/[?#]/)[0].split("/").pop() || "";
    try { archivo = decodeURIComponent(archivo); } catch (x) {}
    archivo = archivo.replace(/\.[a-z0-9]{2,5}$/i, "").replace(/[-_.]+/g, " ").replace(/\b(img|image|imagen|foto|photo|dsc|pic|screenshot)\b/gi, " ").replace(/\d{3,}/g, " ").replace(/\s+/g, " ").trim();
    return /[a-záéíóúñ]{3}/i.test(archivo) ? archivo : "";
  }
  function pedirDescripcion(e, src) {
    if (descripciones[src] === 0) return;
    descripciones[src] = 0;
    var zona = (e.closest && e.closest("figure,section,article,main")) || e.parentElement, contexto = zona ? (zona.innerText || zona.textContent || "").replace(/\s+/g, " ").slice(0, 600) : "";
    fetch(opciones.describir, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ imagen: new URL(src, location.href).href, contexto: contexto, idioma: IDIOMA_UI }) })
      .then(function (r) { return r.ok ? r.json() : null; })
      .then(function (j) {
        var t = j && (j.texto || j.text);
        if (!t) { delete descripciones[src]; return; }
        descripciones[src] = String(t).replace(/\s+/g, " ").trim().slice(0, 400);
        if (opciones.arreglos && (!e.hasAttribute("alt") || e.getAttribute("data-winclus-arreglo") === "alt")) { e.setAttribute("alt", descripciones[src].slice(0, 200)); anotarArreglo("alt", e, 'alt="' + descripciones[src].slice(0, 80) + '"', "servicio de descripción del sitio (data-describir)"); }   // para todos los lectores, no solo el de Winclus
        if (lectorEl === e) anunciar(conRol("Imagen", descripciones[src]));
      }, function () { delete descripciones[src]; });
  }
  function describirImagen(e) {
    // Un alt puesto al vuelo por Winclus (arreglos del sitio) sirve a los demás lectores, pero el propio lector sigue diciendo
    // la verdad: que el sitio no la describió y cuál es la pista
    if (e.hasAttribute("alt") && e.getAttribute("data-winclus-arreglo") !== "alt") return e.alt.trim() ? conRol("Imagen", e.alt.trim()) : T("Imagen decorativa");
    var src = e.currentSrc || e.src || "";
    if (descripciones[src]) return conRol("Imagen", descripciones[src]);
    if (opciones.describir && src) pedirDescripcion(e, src);
    var p = pistaImagen(e);
    return T("Imagen sin descripción del sitio") + (p ? ". " + T("Pista:") + " " + p : "") + (opciones.describir && src ? ". " + T("Pidiendo una descripción…") : "");
  }
  function describir(e) {
    ...
    if (n === "IMG") return describirImagen(e);
  ...
  var GUIA = [
    ...
    [/idioma|traduc|\bingles\b|english|otra lengua|frances|portugues/, function () {
      vistaCompleta(false); elegirTab("inicio"); mostrarIdiomas(true);
      var l = idiomasDelSitio();
      return l.length ? "Este sitio está también en " + l.map(function (x) { return x.nombre; }).join(", ") + ". Te dejo los botones debajo de «Otro idioma»." : "Este sitio no tiene la página en otros idiomas. Te dejo debajo de «Otro idioma» cómo pedirle al navegador que la traduzca.";
    }],
    [/\bpdf\b|documento/, function () { ajustes.pdf_lectura = true; guardar(); refrescos.forEach(function (f) { f(); }); return "Hecho: cuando pulses un documento PDF de este sitio, lo abro en la lectura limpia para leerlo grande y en voz alta."; }],
    ...
    [/muevo poco|no llego|no alcanzo|me canso|estoy cansad|me cuesta mover la cabeza/, function () { return ajustarAlcance() ? "Vamos a ajustar el puntero a lo que puedes mover hoy." : "Para ajustar el puntero, primero activa la cámara."; }],
  ...
  // Alt+Mayúsculas+W abre o cierra el panel desde cualquier sitio de la página, sin tener que llegar al botón con Tab
  document.addEventListener("keydown", function (e) {
    if (e.altKey && e.shiftKey && !e.ctrlKey && e.code === "KeyW") {
      e.preventDefault(); var ab = !panel.classList.contains("abierto"); abrir(ab);
      if (ab) { var p = situEl.querySelector("button"); if (p && panel.classList.contains("sencillo")) p.focus(); } else boton.focus();
    }
  }, true);
  ...
  // idioma de la página, alt de imágenes a partir de lo que ya dice la página (nunca inventado), nombre de
  // botones y enlaces que solo llevan un icono, enlaces «aquí» con su contexto, etiquetas de campos, enlace
  // «Saltar al contenido», zona principal, foco visible, zoom permitido, título de los iframes y cabeceras de
  // tablas. Cada arreglo queda anotado con su selector para que quien mantiene el sitio lo pase al código:
  // un parche al vuelo ayuda hoy, pero no es cumplimiento. data-arreglos="no" en el <script> lo apaga.
  var arreglos = [], pendientes = [], arreglosHechos = false, arreglosTemp = 0, arreglosObs = null;
  var revisados = typeof WeakSet === "function" ? new WeakSet() : { has: function () { return false; }, add: function () {} };
  var VAGOS = /^(aqu[íi]|clic|click|clic aqu[íi]|click here|haga clic aqu[íi]|haz clic aqu[íi]|pulse aqu[íi]|pulsa aqu[íi]|ver|ver m[áa]s|leer|leer m[áa]s|m[áa]s|m[áa]s informaci[óo]n|m[áa]s info|saber m[áa]s|conocer m[áa]s|enlace|link|descargar|descarga|download|continuar|siguiente|ir|read more|more|here|learn more|details|detalles|ampliar)[.…]?$/i;
  var ICONOS = [[/\b(menu|hamburger|navbar-toggler?|toggle-nav|burger|bars)\b/i, "Menú"], [/\b(close|cerrar|dismiss|btn-close|times)\b/i, "Cerrar"], [/\b(search|buscar|buscador)\b/i, "Buscar"],
    [/\b(next|siguiente|slick-next|swiper-button-next|carousel-control-next|angle-right|chevron-right|arrow-right)\b/i, "Siguiente"], [/\b(prev|previous|anterior|slick-prev|swiper-button-prev|carousel-control-prev|angle-left|chevron-left|arrow-left)\b/i, "Anterior"],
    [/\b(play|reproducir)\b/i, "Reproducir"], [/\b(pause|pausar)\b/i, "Pausar"], [/\b(cart|carrito|basket|shopping)\b/i, "Carrito"], [/\b(user|login|account|cuenta|perfil|profile|sign-?in)\b/i, "Cuenta"],
    [/\b(home|inicio)\b/i, "Inicio"], [/\b(share|compartir)\b/i, "Compartir"], [/\b(print|imprimir)\b/i, "Imprimir"], [/\b(download|descargar)\b/i, "Descargar"], [/\b(top|arriba|scroll-?up|back-?to-?top|go-?top)\b/i, "Volver arriba"],
    [/\b(phone|tel|telefono|teléfono|llamar|whatsapp)\b/i, "Teléfono"], [/\b(mail|email|envelope|correo)\b/i, "Correo"], [/\b(filter|filtro)\b/i, "Filtrar"], [/\b(edit|editar|pencil)\b/i, "Editar"], [/\b(delete|remove|borrar|eliminar|trash)\b/i, "Borrar"],
    [/\b(add|plus|añadir|agregar)\b/i, "Añadir"], [/\b(settings|ajustes|config|cog|gear)\b/i, "Ajustes"], [/\b(help|ayuda|question)\b/i, "Ayuda"], [/\b(info)\b/i, "Información"], [/\b(expand|desplegar|chevron|caret|arrow-?down|dropdown)\b/i, "Desplegar"],
    [/\b(lang|idioma|globe)\b/i, "Idioma"], [/\b(map|mapa|marker)\b/i, "Mapa"], [/\b(calendar|calendario)\b/i, "Calendario"], [/\b(zoom|lupa)\b/i, "Ampliar"], [/\b(logo|brand|marca)\b/i, "Página de inicio"], [/\b(dark|theme|tema)\b/i, "Cambiar el tema"]];
  var REDES = [[/facebook\.com/i, "Facebook"], [/twitter\.com|\/\/x\.com/i, "X (Twitter)"], [/instagram\.com/i, "Instagram"], [/youtube\.com|youtu\.be/i, "YouTube"], [/linkedin\.com/i, "LinkedIn"], [/wa\.me|whatsapp\.com/i, "WhatsApp"],
    [/t\.me|telegram\./i, "Telegram"], [/tiktok\.com/i, "TikTok"], [/flickr\.com/i, "Flickr"], [/pinterest\./i, "Pinterest"], [/threads\.net/i, "Threads"], [/^mailto:/i, "Escribir un correo"], [/^tel:/i, "Llamar por teléfono"]];
  function textoDe(e) { return (e.innerText || e.textContent || "").replace(/\s+/g, " ").trim(); }
  function selectorDe(e) {
    if (!e || e.nodeType !== 1) return "";
    if (e.id && !/\s/.test(e.id)) return "#" + e.id;
    var partes = [], n = e;
    while (n && n.nodeType === 1 && n !== document.body && partes.length < 4) {
      if (n.id && !/\s/.test(n.id)) { partes.unshift("#" + n.id); break; }
      var s = n.tagName.toLowerCase(), p = n.parentElement;
      if (p) { var mismos = Array.prototype.filter.call(p.children, function (h) { return h.tagName === n.tagName; }); if (mismos.length > 1) s += ":nth-of-type(" + (mismos.indexOf(n) + 1) + ")"; }
      partes.unshift(s); n = p;
    }
    return partes.join(" > ");
  }
  function anotarArreglo(tipo, e, que, origen) { arreglos.push({ tipo: tipo, selector: selectorDe(e), que: que, origen: origen || "" }); if (e && e.setAttribute) e.setAttribute("data-winclus-arreglo", tipo); }
  function anotarPendiente(tipo, e, que) { pendientes.push({ tipo: tipo, selector: e ? selectorDe(e) : "", que: que }); }
  function clasesDe(e) { var c = e.className; return typeof c === "string" ? c : (c && c.baseVal) || ""; }
  function tieneNombre(e) {
    if ((e.getAttribute("aria-label") || "").trim()) return true;
    var lb = e.getAttribute("aria-labelledby"); if (lb) { var r = document.getElementById(lb.split(" ")[0]); if (r && textoDe(r)) return true; }
    if (textoDe(e)) return true;
    if ((e.getAttribute("title") || "").trim()) return true;
    var im = e.querySelector("img[alt],area[alt],[aria-label]"); if (im && (im.getAttribute("alt") || im.getAttribute("aria-label") || "").trim()) return true;
    var st = e.querySelector("svg title"); if (st && st.textContent.trim()) return true;
    if (e.tagName === "INPUT" && /^(submit|button|reset)$/i.test(e.type || "") && (e.value || "").trim()) return true;
    if (e.tagName === "INPUT" && (e.getAttribute("alt") || "").trim()) return true;
    return false;
  }
  function nombreDeIcono(e) {
    var href = e.getAttribute("href") || "";
    for (var i = 0; i < REDES.length; i++) if (REDES[i][0].test(href)) return REDES[i][1];
    var pistas = [e.id, clasesDe(e), e.getAttribute("data-icon"), e.getAttribute("data-action"), e.getAttribute("name"), e.getAttribute("data-bs-target"), e.getAttribute("data-target")];
    Array.prototype.forEach.call(e.querySelectorAll("i,span,svg,img,use,path"), function (h) { pistas.push(clasesDe(h), h.getAttribute("data-icon") || "", h.getAttribute("href") || h.getAttribute("xlink:href") || h.getAttribute("src") || ""); });
    var s = pistas.join(" ");
    for (var j = 0; j < ICONOS.length; j++) if (ICONOS[j][0].test(s)) return ICONOS[j][1];
    if (/^#/.test(href) && href.length > 1) { var d = document.getElementById(href.slice(1)); var td = d && textoDe(d).slice(0, 60); if (td) return "Ir a " + td; }
    return "";
  }
  function contextoDeEnlace(e) {
    // El texto del bloque que contiene el enlace (párrafo, celda, elemento de lista) si dice algo; si no, el título
    // más cercano que lo precede; y si no, el nombre del archivo del destino
    var bloque = e.closest("li,td,th,p,figcaption,dd"), n = e, tope = 0;
    if (bloque && bloque !== e) { var tb = textoDe(bloque).replace(textoDe(e), "").replace(/\s+/g, " ").replace(/\s+([.,;:])/g, "$1").replace(/^[\s.,;:]+|[\s.,;:]+$/g, "").trim(); if (tb.split(" ").length >= 3) return tb.slice(0, 90); }
    bloque = e.closest("li,td,th,p,figure,article,section,aside,header,footer,div");
    while (n && n !== document.body && tope++ < 12) {
      var prev = n.previousElementSibling;
      while (prev) { if (/^H[1-6]$/.test(prev.tagName)) return textoDe(prev); var h = prev.querySelector && prev.querySelector("h1,h2,h3,h4,h5,h6"); if (h && prev.contains(h)) { var hs = prev.querySelectorAll("h1,h2,h3,h4,h5,h6"); return textoDe(hs[hs.length - 1]); } prev = prev.previousElementSibling; }
      n = n.parentElement;
    }
    if (bloque && bloque !== e) { var t = textoDe(bloque).replace(textoDe(e), "").replace(/\s+/g, " ").trim(); if (t) return t.slice(0, 90); }
    var archivo = (e.getAttribute("href") || "").split(/[?#]/)[0].split("/").pop() || "";
    try { archivo = decodeURIComponent(archivo); } catch (x) {}
    return archivo.replace(/\.[a-z0-9]{2,5}$/i, "").replace(/[-_.]+/g, " ").trim();
  }
  function tipoArchivo(href) { var m = /\.(pdf|docx?|xlsx?|pptx?|zip|rar|mp3|mp4|odt|ods|csv)(\?|#|$)/i.exec(href || ""); return m ? " (" + m[1].toUpperCase() + ")" : ""; }
  function etiquetaCercana(e) {
    // Texto justo antes del campo: un hermano corto, un nodo de texto o la celda de al lado en un formulario en tabla
    var prev = e.previousSibling, saltos = 0;
    while (prev && saltos++ < 4) {
      if (prev.nodeType === 3 && prev.textContent.trim()) return prev.textContent.replace(/\s+/g, " ").trim().slice(0, 60);
      if (prev.nodeType === 1) { if (prev.matches("input,select,textarea,button,a,br")) { if (prev.tagName !== "BR") break; } else { var t = textoDe(prev); if (t && t.length <= 60) return t; if (t) break; } }
      prev = prev.previousSibling;
    }
    var celda = e.closest("td"); if (celda && celda.previousElementSibling) { var tc = textoDe(celda.previousElementSibling); if (tc && tc.length <= 60) return tc; }
    var p = e.parentElement; if (p && p.matches("p,div,li,span") && p.querySelectorAll("input,select,textarea").length === 1) { var tp = textoDe(p).replace(e.value || "", "").trim(); if (tp && tp.length <= 60) return tp; }
    return "";
  }
  var CAMPOS_TIPO = { search: "Buscar", email: "Correo electrónico", tel: "Teléfono", password: "Contraseña", date: "Fecha", url: "Dirección web", number: "Número", file: "Archivo" };
  function arreglarIdioma() {
    var l = (raiz.getAttribute("lang") || "").trim();
    if (l) return;
    var nuevo = (IDIOMA_VOZ || "es").split("-")[0].toLowerCase() || "es";
    raiz.setAttribute("lang", nuevo); anotarArreglo("idioma", raiz, 'lang="' + nuevo + '" en <html>', "idioma del sitio (data-idioma)");
  }
  function arreglarImagenes(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("img:not([alt])"), function (im) {
      if (revisados.has(im) || enWidget(im)) return; revisados.add(im);
      if (im.getAttribute("aria-label") || im.getAttribute("aria-labelledby") || im.getAttribute("role") === "presentation" || im.getAttribute("aria-hidden") === "true") return;
      var src = im.currentSrc || im.getAttribute("src") || "", w = im.getAttribute("width"), h = im.getAttribute("height");
      var decorativa = (w && +w <= 4) || (h && +h <= 4) || /(^|\/)(spacer|pixel|blank|transparent|1x1|tracking|beacon)\b/i.test(src);
      var enlace = im.closest("a,button"), textoEnlace = enlace ? textoDe(enlace) : "";
      if (decorativa || (enlace && textoEnlace)) { im.setAttribute("alt", ""); anotarArreglo("alt", im, 'alt="" (imagen decorativa' + (enlace && textoEnlace ? ": el enlace ya tiene texto" : "") + ")", "tamaño o contexto"); return; }
      var t = (im.getAttribute("title") || "").trim(), origen = "atributo title";
      if (!t) { var fig = im.closest("figure"), cap = fig && fig.querySelector("figcaption"); if (cap && textoDe(cap)) { t = textoDe(cap); origen = "pie de foto"; } }
      if (!t && enlace) { t = nombreDeIcono(enlace); origen = "destino del enlace"; }
      // Con servicio de descripción (data-describir) no se pone el nombre del archivo: el lector de Winclus pedirá la descripción
      // al llegar a la imagen y entonces se pondrá como alt (no se piden todas al cargar: cada petición le cuesta al sitio)
      if (!t && opciones.describir && src) { anotarPendiente("alt-ia", im, "imagen sin alt: cuando el lector llegue a ella se pedirá la descripción al servicio del sitio (data-describir) y se pondrá como alt"); return; }
      if (!t) { var p = pistaImagen(im); if (p) { t = p; origen = "nombre del archivo (provisional: hay que escribir el definitivo)"; } }
      if (!t) { anotarPendiente("alt", im, "imagen sin alt y sin ninguna pista en la página: el sitio debe describirla"); return; }
      im.setAttribute("alt", t.slice(0, 200)); anotarArreglo("alt", im, 'alt="' + t.slice(0, 80) + '"', origen);
    });
  }
  function arreglarEnlaces(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("a[href]"), function (a) {
      if (revisados.has(a) || enWidget(a)) return; revisados.add(a);
      var href = a.getAttribute("href") || "";
      if (a.getAttribute("aria-label") || a.getAttribute("aria-labelledby")) return;
      var t = textoDe(a);
      if (!t) {
        if (tieneNombre(a)) return;
        var n = nombreDeIcono(a);
        if (n) { a.setAttribute("aria-label", n); anotarArreglo("nombre", a, 'aria-label="' + n + '" en un enlace que solo lleva un icono', "clases, icono o destino"); }
        else if (!a.querySelector("img")) anotarPendiente("nombre", a, "enlace sin texto ni nombre: hay que ponerle aria-label o texto");   // con imagen sin alt ya quedó anotado
        return;
      }
      if (VAGOS.test(t)) {
        var ctx = contextoDeEnlace(a), ext = tipoArchivo(href);
        if (ctx && ctx.toLowerCase() !== t.toLowerCase()) { var nl = t + ": " + ctx.slice(0, 90) + ext; a.setAttribute("aria-label", nl); anotarArreglo("enlace", a, 'aria-label="' + nl + '" (el enlace decía solo «' + t + '»)', "título o texto que lo rodea"); }
        else anotarPendiente("enlace", a, "enlace «" + t + "» sin nada alrededor que diga a dónde lleva");
      } else if (tipoArchivo(href) && !/\b(pdf|docx?|xlsx?|pptx?|zip|mp3|mp4|csv)\b/i.test(t)) { a.setAttribute("aria-label", t + tipoArchivo(href)); anotarArreglo("enlace", a, 'aria-label="' + t + tipoArchivo(href) + '": dice qué tipo de archivo abre', "extensión del archivo"); }
    });
  }
  function arreglarBotones(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("button,[role=button],input[type=image],input[type=button],input[type=submit]"), function (b) {
      if (revisados.has(b) || enWidget(b)) return; revisados.add(b);
      if (tieneNombre(b)) return;
      var n = nombreDeIcono(b);
      if (!n && b.tagName === "INPUT") n = b.type === "submit" ? "Enviar" : b.type === "image" ? "" : "";
      if (n) { b.setAttribute("aria-label", n); anotarArreglo("nombre", b, 'aria-label="' + n + '" en un botón sin texto', "clases o icono"); }
      else anotarPendiente("nombre", b, "botón sin texto ni nombre: hay que ponerle aria-label o texto");
    });
  }
  function arreglarCampos(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("input:not([type=hidden]):not([type=submit]):not([type=button]):not([type=reset]):not([type=image]),select,textarea"), function (c) {
      if (revisados.has(c) || enWidget(c)) return; revisados.add(c);
      if ((c.labels && c.labels.length) || c.closest("label") || c.getAttribute("aria-label") || c.getAttribute("aria-labelledby") || (c.getAttribute("title") || "").trim()) return;
      var t = (c.getAttribute("placeholder") || "").trim(), origen = "placeholder";
      if (!t) { t = etiquetaCercana(c); origen = "texto de al lado"; }
      if (!t && CAMPOS_TIPO[(c.type || "").toLowerCase()]) { t = CAMPOS_TIPO[(c.type || "").toLowerCase()]; origen = "tipo del campo"; }
      if (!t && c.name) { t = c.name.replace(/[\[\]_.-]+/g, " ").replace(/([a-z])([A-Z])/g, "$1 $2").trim(); origen = "atributo name (provisional)"; }
      if (!t) { anotarPendiente("campo", c, "campo de formulario sin etiqueta y sin ninguna pista"); return; }
      c.setAttribute("aria-label", t.slice(0, 80)); anotarArreglo("campo", c, 'aria-label="' + t.slice(0, 60) + '" en un campo sin etiqueta', origen);
    });
  }
  function contenidoPrincipal() {
    var m = document.querySelector("main,[role=main]"); if (m) return m;
    m = document.querySelector("#main,#content,#contenido,#contenido-principal,#main-content,#primary,.main-content,#page-content"); if (m && !m.closest("header,nav,footer")) return m;
    var hs = document.querySelectorAll("h1"); if (hs.length !== 1 || hs[0].closest("header,nav,footer,aside") || enWidget(hs[0])) return null;
    var n = hs[0].parentElement, elegido = null;
    while (n && n !== document.body) { var p = n.parentElement; if (p === document.body || (p && p.querySelector(":scope > header, :scope > nav, :scope > footer"))) { elegido = n; break; } n = p; }
    return elegido && !elegido.querySelector("header,nav,footer") ? elegido : null;
  }
  function arreglarPrincipal() {
    if (document.querySelector("main,[role=main]")) return;
    var m = contenidoPrincipal(); if (!m) { anotarPendiente("principal", null, "la página no tiene una zona <main> y no se pudo deducir"); return; }
    m.setAttribute("role", "main"); anotarArreglo("principal", m, 'role="main" en la zona del contenido (mejor: usar <main>)', "el bloque que contiene el título principal");
  }
  function arreglarSalto() {
    var focables = document.querySelectorAll("a[href],button,input,select,textarea,[tabindex]"), hay = false;
    for (var i = 0; i < focables.length && i < 4; i++) { var f = focables[i]; if (enWidget(f)) continue; if (f.tagName === "A" && /^#./.test(f.getAttribute("href") || "") && /(ir|saltar|salta) al contenido|skip to|contenido principal|main content/i.test(textoDe(f) + " " + (f.getAttribute("aria-label") || ""))) hay = true; }
    if (hay || !document.body) return;
    var m = contenidoPrincipal(); if (!m) return;
    if (!m.id) m.id = "winclus-contenido";
    if (!m.hasAttribute("tabindex")) m.setAttribute("tabindex", "-1");
    var a = document.createElement("a"); a.href = "#" + m.id; a.textContent = T("Saltar al contenido"); a.className = "winclus-salto"; a.setAttribute("data-winclus-arreglo", "salto");
    var oculto = function () { a.style.cssText = "position:absolute;left:-9999px;top:0;z-index:2147483646;padding:10px 16px;background:#101F3D;color:#FFFFFF;font:700 18px/1.2 system-ui,sans-serif;text-decoration:none;border-radius:0 0 10px 0"; };
    oculto();
    a.addEventListener("focus", function () { a.style.left = "0"; a.style.outline = "3px solid #FFE45C"; });
    a.addEventListener("blur", oculto);
    a.addEventListener("click", function (ev) { ev.preventDefault(); m.focus(); m.scrollIntoView(); });
    document.body.insertBefore(a, document.body.firstChild);
    anotarArreglo("salto", a, "enlace «Saltar al contenido» al principio de la página (WCAG 2.4.1)", "no había ninguno");
  }
  function sitioQuitaElFoco() {
  ...
  var focoEstilo = null;
  function arreglarFoco() {
    var sel = sitioQuitaElFoco(); if (!sel || focoEstilo) return;
    focoEstilo = estiloCon("a:focus-visible,button:focus-visible,input:focus-visible,select:focus-visible,textarea:focus-visible,summary:focus-visible,[tabindex]:focus-visible,[role=button]:focus-visible,[role=link]:focus-visible{outline:3px solid #2743B4!important;outline-offset:2px!important}");
    focoEstilo.setAttribute("data-winclus-arreglo", "foco");
    (document.head || raiz).appendChild(focoEstilo);
    anotarArreglo("foco", focoEstilo, "foco visible al navegar con teclado (el sitio lo quitaba con «" + sel + "»)", "hojas de estilo del sitio");
  }
  function arreglarZoom() {
    var m = document.querySelector("meta[name=viewport]"); if (!m) return;
    var c = m.getAttribute("content") || "";
    if (!/user-scalable\s*=\s*(no|0)|maximum-scale\s*=\s*(0?\.\d+|1(\.0*)?)(\s*[,;]|$)/i.test(c)) return;
    var nuevo = c.replace(/,?\s*user-scalable\s*=\s*(no|0)/ig, "").replace(/,?\s*maximum-scale\s*=\s*[0-9.]+/ig, "").replace(/^\s*,\s*/, "").trim();
    m.setAttribute("content", nuevo); anotarArreglo("zoom", m, "el sitio prohibía ampliar con los dedos: ahora se puede (WCAG 1.4.4)", 'content="' + c + '"');
  }
  function arreglarIframes(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("iframe:not([title]),iframe[title='']"), function (f) {
      if (revisados.has(f) || enWidget(f) || f.getAttribute("aria-hidden") === "true") return; revisados.add(f);
      var src = f.getAttribute("src") || "", host = ""; try { host = new URL(src, location.href).hostname.replace(/^www\./, ""); } catch (x) {}
      var t = /youtube|youtu\.be/i.test(src) ? "Vídeo de YouTube" : /vimeo/i.test(src) ? "Vídeo de Vimeo" : /google\.[a-z.]+\/maps|maps\.google/i.test(src) ? "Mapa de Google Maps" : /facebook\.com\/plugins/i.test(src) ? "Contenido de Facebook" : host ? "Contenido incrustado de " + host : "Contenido incrustado";
      f.setAttribute("title", t); anotarArreglo("iframe", f, 'title="' + t + '"', "dirección del iframe");
    });
  }
  function arreglarTablas(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("table"), function (t) {
      if (revisados.has(t) || enWidget(t)) return; revisados.add(t);
      if (t.getAttribute("role") || t.querySelector("th") || t.rows.length < 2 || t.rows[0].cells.length < 2 || t.querySelector("table")) return;
      var celdas = Array.prototype.slice.call(t.rows[0].cells), textos = celdas.map(textoDe);
      if (!textos.every(function (x) { return x && x.length <= 40 && !/^[\d.,\s%$€-]+$/.test(x); })) return;
      var n = 0; celdas.forEach(function (c) { if (!c.querySelector("input,select,textarea,button,img")) { c.setAttribute("role", "columnheader"); c.setAttribute("scope", "col"); n++; } });
      if (n === celdas.length) anotarArreglo("tabla", t, "la primera fila se anuncia como cabecera de columnas (mejor: usar <th scope=\"col\">)", "la primera fila lleva textos cortos");
    });
  }
  function arreglarMedios(base) {
    Array.prototype.forEach.call((base || document).querySelectorAll("video[autoplay]:not([controls]),audio[autoplay]:not([controls])"), function (v) {
      if (revisados.has(v) || enWidget(v) || v.muted || v.hasAttribute("muted")) return; revisados.add(v);
      v.controls = true; anotarArreglo("medio", v, "controles visibles en un " + (v.tagName === "VIDEO" ? "vídeo" : "audio") + " que arranca solo con sonido (WCAG 1.4.2)", "arrancaba sin controles");
    });
  }
  function revisarSinArreglo() {
    // Lo que no se puede tocar sin riesgo de romper el sitio se anota para quien lo mantiene
    var ids = {}, dobles = [];
    Array.prototype.forEach.call(document.querySelectorAll("[id]"), function (e) { if (enWidget(e)) return; var id = e.id; if (ids[id]) { if (ids[id] === 1) dobles.push(id); ids[id]++; } else ids[id] = 1; });
    if (dobles.length) anotarPendiente("id", null, dobles.length + " id repetido(s): " + dobles.slice(0, 6).join(", ") + (dobles.length > 6 ? "…" : "") + " (los lectores y las etiquetas solo encuentran el primero)");
    var hs = Array.prototype.filter.call(document.querySelectorAll("h1,h2,h3,h4,h5,h6"), function (h) { return !enWidget(h); });
    if (!hs.some(function (h) { return h.tagName === "H1"; })) anotarPendiente("titulos", null, "la página no tiene un título <h1>");
    var vacios = hs.filter(function (h) { return !textoDe(h) && !h.querySelector("img[alt]:not([alt=''])"); });
    if (vacios.length) anotarPendiente("titulos", vacios[0], vacios.length + " título(s) vacío(s)");
    for (var i = 1, saltos = 0; i < hs.length; i++) if (+hs[i].tagName[1] > +hs[i - 1].tagName[1] + 1) saltos++;
    if (saltos) anotarPendiente("titulos", null, saltos + " salto(s) de nivel en los títulos (por ejemplo de h2 a h4)");
    var tab = Array.prototype.filter.call(document.querySelectorAll("[tabindex]"), function (e) { return !enWidget(e) && +e.getAttribute("tabindex") > 0; });
    if (tab.length) anotarPendiente("orden", tab[0], tab.length + " elemento(s) con tabindex mayor que 0: rompen el orden del teclado");
    var oc = Array.prototype.filter.call(document.querySelectorAll("[aria-hidden=true] a[href],[aria-hidden=true] button,[aria-hidden=true] input"), function (e) { return !enWidget(e) && !e.disabled && e.getAttribute("tabindex") !== "-1"; });
    if (oc.length) anotarPendiente("oculto", oc[0], oc.length + " control(es) ocultos a los lectores (aria-hidden) pero alcanzables con el teclado");
  }
  function arreglarNuevos(base) { arreglarImagenes(base); arreglarEnlaces(base); arreglarBotones(base); arreglarCampos(base); arreglarIframes(base); arreglarTablas(base); arreglarMedios(base); }
  function arreglarSitio() {
    if (!opciones.arreglos || arreglosHechos || !document.body) return;
    arreglosHechos = true;
    try {
      arreglarIdioma(); arreglarZoom(); arreglarPrincipal(); arreglarSalto(); arreglarFoco(); arreglarNuevos(document); revisarSinArreglo();
      if (typeof MutationObserver === "function") {
        arreglosObs = new MutationObserver(function (lista) {
          var hayNuevos = lista.some(function (m) { return m.addedNodes && Array.prototype.some.call(m.addedNodes, function (n) { return n.nodeType === 1 && !enWidget(n); }); });
          if (!hayNuevos || arreglosTemp) return;
          arreglosTemp = setTimeout(function () { arreglosTemp = 0; try { arreglarNuevos(document); } catch (e) {} }, 400);   // las SPA y los carruseles traen contenido nuevo
        });
        arreglosObs.observe(document.body, { childList: true, subtree: true });
      }
    } catch (e) {}
    refrescos.forEach(function (f) { f(); });
  }
  function informeArreglos() {
    var fecha = new Date().toISOString().slice(0, 10), t = [];
    t.push("Winclus " + VERSION + " · " + location.href + " · " + fecha);
    t.push(arreglos.length ? "Arreglos que Winclus hizo al vuelo en esta página (" + arreglos.length + "). Ayudan hoy a quien usa lector de pantalla, teclado o zoom, pero no son cumplimiento: hay que pasarlos al código del sitio." : "Winclus no tuvo que arreglar nada al vuelo en esta página.");
    arreglos.forEach(function (a, i) { t.push((i + 1) + ". " + a.selector + " → " + a.que + (a.origen ? " [a partir de: " + a.origen + "]" : "")); });
    if (pendientes.length) { t.push(""); t.push("Lo que necesita a una persona (" + pendientes.length + "):"); pendientes.forEach(function (p, i) { t.push((i + 1) + ". " + (p.selector ? p.selector + " → " : "") + p.que); }); }
    return t.join("\n");
  }
  function montar() {
    ...
    aplicarTodo();
    arreglarSitio();   // antes de que nadie empiece a leer: alt, nombres, etiquetas, «Saltar al contenido», foco, zoom, lang
