...
(function () {
  ...
  var POR_DEFECTO = {
    ...
    dalton: "no", calma: false, colores: "no", color_texto: "#000000", color_fondo: "#FFFFFF", dislexia: false, sinimg: false, mascara: false, lector: false, facil: false,
  ...
  function activos() {
    ...
    if (a.cursor_grande) l.push("Cursor grande"); if (a.animaciones) l.push("Sin movimiento"); if (a.dalton !== "no") l.push("Colores corregidos"); if (a.calma) l.push("Modo calma"); if (a.colores !== "no") l.push("Colores de la página");
  ...
  function apagarTodo() {
    ...
    ajustes.texto = 100; ajustes.dalton = "no"; ajustes.colores = "no"; guardar();
