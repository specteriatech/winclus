...
(function () {
  ...
  var POR_DEFECTO = {
    ...
    iman_activo: true, iman_radio_px: 90, iman_cabeza: false, calib_invisible: true, calib_modo: "normal", calib_lento: false, calib_punto_grande: false, calib_cabeza: true, puntero_externo: false,
  ...
  function vuelta(tS) {
    ...
    if (!pausado && ajustes.puntero_externo) { tickClics(tS); tickMenu(tS); tickTeclado(); cursor.style.opacity = ""; return; }   // el puntero lo lleva otro aparato (Tobii, Windows Eye Control): solo clics y gestos
    if (!pausado) {
