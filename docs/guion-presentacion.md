...
- **«¿Y si se rompe nuestro sitio?»** «Vive aislado (shadow root): ni sus estilos entran ni los nuestros salen. Está probado con una página hostil y con CSP estricta. Y usan una versión fija: no cambia hasta que ustedes decidan.»
