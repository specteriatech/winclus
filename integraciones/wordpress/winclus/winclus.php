...
define( 'WINCLUS_VERSION_WIDGET', '0.6.6' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-xUhuJ5WBsO3g9k5AuKiRFXv59Si8sSdcp3yc590lJVPCucMVHKf2ByrtUNpSpKuG' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.6.js (no cambia solo); «ultima»: widget.js
	) );
}
