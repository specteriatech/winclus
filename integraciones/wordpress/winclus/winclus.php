...
define( 'WINCLUS_VERSION_WIDGET', '0.6.2' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-hajVMdiejH0TjtcE7uXXms/m8Muws3AeIMbn2rpTA34NN3wrG7/F33dh4E2bNJBS' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.2.js (no cambia solo); «ultima»: widget.js
	) );
}
