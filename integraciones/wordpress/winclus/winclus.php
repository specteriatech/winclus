...
define( 'WINCLUS_VERSION_WIDGET', '0.6.16' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-usAOOescY/bMYI6ymG/zndiOs/Emc8plZLNuZ93feG9pD43+qFsnmphdVMw21xCh' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'ultima', // «ultima»: widget.js, las mejoras llegan solas; «fija»: widget-0.6.16.js con SRI (no cambia nunca)
	) );
}
