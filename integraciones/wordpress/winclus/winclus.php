...
define( 'WINCLUS_VERSION_WIDGET', '0.6.18' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-wXq+E2oMu0vWYc/YFxNJsPwA3nGsm0xVY1JFmzrBIhRmrQZ60exENOMibbBop2yH' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'ultima', // «ultima»: widget.js, las mejoras llegan solas; «fija»: widget-0.6.18.js con SRI (no cambia nunca)
	) );
}
