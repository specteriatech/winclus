...
define( 'WINCLUS_VERSION_WIDGET', '0.6.17' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-i6DGtsaek6KMKS47oaxZ4ECCGyjmbPZoUlcifa67SL9BDct/8LDkWZDbxg2M6F+U' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'ultima', // «ultima»: widget.js, las mejoras llegan solas; «fija»: widget-0.6.17.js con SRI (no cambia nunca)
	) );
}
