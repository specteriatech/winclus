...
define( 'WINCLUS_VERSION_WIDGET', '0.6.11' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-h2HUVOQAsVlchqrS9IavjbKcY/paF0ZX/eXOp4rtGR1QQuiq3RL6Z9NsulQGk6u3' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.11.js (no cambia solo); «ultima»: widget.js
	) );
}
