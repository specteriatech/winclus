...
define( 'WINCLUS_VERSION_WIDGET', '0.6.7' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-8Z8VOCMVo8gUcDAs2xoaSr2oo+OO4GDrmblT+xU5b7yrTOuT3mPKV6IHtWFGlntE' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.7.js (no cambia solo); «ultima»: widget.js
	) );
}
