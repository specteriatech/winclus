...
define( 'WINCLUS_VERSION_WIDGET', '0.6.4' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-RCTjJXKtaYqPauMYailMtO4ArpEiagm8X98p3MrBoK/sDWYtV4EQ42lPmnqhpNVg' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.4.js (no cambia solo); «ultima»: widget.js
	) );
}
