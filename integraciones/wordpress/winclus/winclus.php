...
define( 'WINCLUS_VERSION_WIDGET', '0.6.5' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-5PMKt/ugENTetSOENiqjJNXttp+98YD3WXDrIJvZGiD5GIPW5xW6I8qsdwAsubb3' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.5.js (no cambia solo); «ultima»: widget.js
	) );
}
