...
define( 'WINCLUS_VERSION_WIDGET', '0.6.3' );
define( 'WINCLUS_SRI_WIDGET', 'sha384-FeiNXFNVKDCeM1Ij/mlzczg34t44aNH37bUr+UiW2lqmRpmyed/p0wUoidZ45c1g' );   // hash de integridad de la versión fija (winclus.com/integrar)
...
function winclus_opciones() {
	return wp_parse_args( get_option( 'winclus_opciones', array() ), array(
		...
		'relevo'   => 'si',
		'explicar' => '',
		'version'  => 'fija',   // «fija»: widget-0.6.3.js (no cambia solo); «ultima»: widget.js
	) );
}
